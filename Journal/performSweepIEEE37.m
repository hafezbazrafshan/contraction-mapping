...
sweep_path=gen_path(38,inc_mat, sNodes,rNodes);  % generate a sweep path from the substation
cnt=0; 
...
labelsNoRegs=[labelsNoRegs(labelsNoRegs~=799);799];
