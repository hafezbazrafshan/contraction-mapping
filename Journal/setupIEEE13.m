...
for i=1:length(loadIndices)
 ...
 AuxIdx=find(   allNodesActualLabels==632);
        linIdxAux1=phaseNodesLinIndices(AuxIdx,1);
    linIdxAux2=phaseNodesLinIndices(AuxIdx,2);
    linIdxAux3=phaseNodesLinIndices(AuxIdx,3);
    
      sL([linIdxAux1,linIdxAux2,linIdxAux3],1)=sLoad1;
           ...
           cMat(linIdxAux1,1)=1;
           ePage(linIdxAux1, linIdxAux1,1)=1;
           
           
           
           cMat(linIdxAux2,1)=1;
           ePage(linIdxAux2,linIdxAux2,1)=1;
           
           cMat(linIdxAux3,1)=1;
           ePage(linIdxAux3,linIdxAux3,1)=1;
...
%% 6. Saving the IEEE123data for usage
