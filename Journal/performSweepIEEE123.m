...
sweep_path=gen_path(130,inc_mat, sNodes,rNodes);  % generate a sweep path from the substation
cnt=0; 
...
labelsNoRegs=allNodesActualLabels(allNodesActualLabels~=1001 & allNodesActualLabels~=1002 & allNodesActualLabels~=1003 & allNodesActualLabels~=1004);
labelsNoRegs=[labelsNoRegs(labelsNoRegs~=150);150];


v3phaseRegs=v3phase(allNodesActualLabels==1001| allNodesActualLabels==1002  | allNodesActualLabels==1003 | allNodesActualLabels==1004,:);
v3phaseNet=v3phase(allNodesActualLabels~=1001 & allNodesActualLabels~=1002 & allNodesActualLabels~=1003 & allNodesActualLabels~=1004,:);
...
allNodesActualLabelsWithRegs=[labelsNoRegs;1001;1002;1003;1004];
